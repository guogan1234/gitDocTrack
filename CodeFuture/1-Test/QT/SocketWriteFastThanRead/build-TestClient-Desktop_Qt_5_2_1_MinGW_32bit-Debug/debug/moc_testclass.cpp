...
#include "../../TestClient/testclass.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestClass_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 72, 28),
QT_MOC_LITERAL(7, 101, 11),
QT_MOC_LITERAL(8, 113, 13)
    },
    "TestClass\0stateChangedSlot\0\0"
    "QAbstractSocket::SocketState\0stat\0"
    "errorSlot\0QAbstractSocket::SocketError\0"
    "socketError\0connectedSlot\0"
};
...
void TestClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->stateChangedSlot((*reinterpret_cast< QAbstractSocket::SocketState(*)>(_a[1]))); break;
        case 1: _t->errorSlot((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
...
const QMetaObject TestClass::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestClass.data,
      qt_meta_data_TestClass,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestClass.stringdata))
