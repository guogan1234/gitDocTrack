...
@Data
@Entity
@Table(name = "sys_user", schema = "bussiness")
public class SysUser implements UserDetails {
    ...
    @JoinTable(schema = "bussiness",name = "sys_user_role", joinColumns = {@JoinColumn(name = "user_id")}, inverseJoinColumns = @JoinColumn(name = "role_id"))
