var stationId1 = localStorage.getItem('for-stationId1');
var stationId2 = localStorage.getItem('for-stationId2');
if (stationId1 == null || stationId2 == null) { //首次进来时，默认选中前两个站
    stationId1 = getStations()[0].value;
    stationId2 = getStations()[1].value;
}

var calender = localStorage.getItem('for-calender');
...
function initDatas() {
    ...
    var map = new Map();
    AJAX_GET('/stationSharePredict', param, function callback(data) {
        if (data.code > 0) {
...
function initHightcharts(data) {
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 分时10分钟客流预测'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container2').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 分时30分钟客流预测'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container3').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 分时60分钟客流预测'
        },
        subtitle: {
            text: calender
        },
