...
var calender = localStorage.getItem('lcon-calender');
...
function initHightcharts(data) {
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 分时10分钟客流对比'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container2').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 分时30分钟客流对比'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container3').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 分时60分钟客流对比'
        },
        subtitle: {
            text: calender
        },
