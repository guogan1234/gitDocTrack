var stationId1 = localStorage.getItem('tot-stationId1');
var stationId2 = localStorage.getItem('tot-stationId2');
if (stationId1 == null || stationId2 == null) {  //首次进来时，默认选中前两个站
    stationId1 = getStations()[0].value;
    stationId2 = getStations()[1].value;
}

var calender = localStorage.getItem('tot-calender');
...
function initHightcharts(data) {
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 累计10分钟客流对比'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container2').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 累计30分钟客流对比'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container3').highcharts({
        ...
        title: {
            text: data[stationId1].stationName + ' ' + data[stationId2].stationName + ' 累计60分钟客流对比'
        },
        subtitle: {
            text: calender
        },
