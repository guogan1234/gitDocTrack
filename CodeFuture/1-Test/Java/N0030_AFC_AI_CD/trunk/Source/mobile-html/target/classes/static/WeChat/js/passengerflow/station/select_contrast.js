...
function btnSubmit() {
    ...
    localStorage.setItem("con-stationId1", stationId1);
    localStorage.setItem("con-stationId2", stationId2);
    localStorage.setItem("con-calender", calender);

    window.location.href = 'skip?path=passengerflow/station/listDetail_contrast';
}
