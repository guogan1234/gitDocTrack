...
<header class='report-header'>
    <h2 class="report-title">模块故障分析条件筛选</h2>
</header>
<div class="weui-cells weui-cells_form cells-font-size" id="mainForm">
    ...
    <div class="weui-cell weui-cell_select div-height">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" id="line" placeholder='必选项'>
        </div>
    </div>
    <div class="weui-cell weui-cell_select div-height">
        <div class="weui-cell__hd"><label class="weui-label">模块</label></div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" id="module" placeholder='必选项'>
        </div>
    </div>
    <div class="weui-cell weui-cell_select div-height">
        <div class="weui-cell__hd"><label class="weui-label">时间范围</label></div>
        <div class="weui-cell__bd">
            <input class="weui-input" type="text" data-toggle='date' id='time' placeholder='默认为6个月'/>
        </div>
    </div>
...
<script src="/${PATH}/js/fault/moduleFailure_select.js?time=New Date()"></script>
