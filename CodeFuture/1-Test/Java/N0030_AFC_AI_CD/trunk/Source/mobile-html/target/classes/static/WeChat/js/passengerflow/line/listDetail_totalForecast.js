...
var calender = localStorage.getItem('ltotf-calender');
...
function initDatas() {
    ...
    var map = new Map();
    AJAX_GET('/lineSumPredict', param, function callback(data) {
        if (data.code > 0) {
...
function initHightcharts(data) {
    ...
    $('#container1').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 累计10分钟客流预测'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container2').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 累计30分钟客流预测'
        },
        subtitle: {
            text: calender
        },
    ...
    $('#container3').highcharts({
        ...
        title: {
            text: data[lineId].lineName + ' 累计60分钟客流预测'
        },
        subtitle: {
            text: calender
        },
