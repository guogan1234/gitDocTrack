...
<#--<@header />-->
    ...
    <#--<style>-->
        <#--.report-header {padding: 5px 0;}-->
        <#--.div-height{height: 35px; padding: 5px 15px;}-->
        <#--.sbbmdiv-height{padding: 5px 15px;}-->
        <#--.report-title {-->
            <#--text-align: center;-->
            <#--font-size: 21px;-->
            <#--font-weight: 500;-->
...
<#--<header class='report-header'>-->
    <#--<h2 class="report-title">消耗分析条件筛选</h2>-->
<#--</header>-->
...
<#--<@bottom />-->
    ...
    <#--<script src="/${PATH}/js/consumptive/consumablesAnalysis_select.js?time=New Date()"></script>-->
