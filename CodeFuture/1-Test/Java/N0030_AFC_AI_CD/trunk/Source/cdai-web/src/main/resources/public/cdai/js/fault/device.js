...
function deviceModuleSearch() {
    ...
    AJAX_GET('/DeviceFailedDetail/percent', param, function callback(data) {
        if (data.code > 0) {
    ...
    AJAX_GET('/DeviceFailedDetail/count', param, function callback(data) {
        if (data.code > 0) {
            column1 = data.result.xValue;
