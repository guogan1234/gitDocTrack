 ...
 */
@RestController
public class LineSharePredictController {
    ...
    @RequestMapping(value = "lineSharePredict",method = RequestMethod.GET)
...
//                logger.debug("lineSharePredict--起始时间为：{}，结束时间为：{}", strStart, strEnd);
...
//            }
            ...
            for (ObjLine obj : objList) {
                ...
                for (int i = 0; i < 3; i++) {
                    ...
                    List<Object[]> list = lineSharePredictRepository.getData2(id,startTime,endTime,section,direct);
