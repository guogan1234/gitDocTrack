                    ...
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[i][2] !== 'undefined') {
                            	if(settings.columns.editable[i][2] == 'number' || settings.columns.editable[i][2] == 'email'){
                            		var input = '<input class="tabledit-input ' + settings.inputClass + '" type="' + settings.columns.editable[i][2] + '" name="' + settings.columns.editable[i][1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                            	}else{
