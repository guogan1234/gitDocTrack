...
var moduleName = localStorage.getItem("moduleName");

var startTime = localStorage.getItem("startTime");
var timeSpanId = localStorage.getItem("timeSpanId");
...
function stationSearch() {
    ...
    AJAX_GET('/moduleFailedDetail/count', param, function callback(data) {
        if (data.code > 0) {
    ...
    AJAX_GET('/moduleFailedDetail/percent', param, function callback(data) {
        if (data.code > 0) {
            column1 = data.result.xValue;
