...
//			System.out.println(emp.getLastName());
		...
		String s1 = "from Employee emp where emp.id>? and emp.salary<?";
		...
		String s2 = "from Employee where id>:id and salary<:salary";
		Query q2 = session.createQuery(s2);
		Employee emp1 = new Employee();
		emp1.setId(333);
		emp1.setSalary(3333D);
		q2.setProperties(emp1);
		Iterator it8 = q2.iterate();
		while(it8.hasNext()) {
