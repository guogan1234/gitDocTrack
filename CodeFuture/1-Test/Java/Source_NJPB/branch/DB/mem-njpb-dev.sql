...
CREATE TABLE obj_barcode_image (
    ...
    bar_code_sn character varying(255) DEFAULT nextval('seq_bar_code'::regclass),
    bar_code_message character varying(255) DEFAULT nextval('seq_bar_code_message'::regclass),
...
--
-- Name: COLUMN obj_estate.bicycle_stake_bar_code; Type: COMMENT; Schema: business; Owner: mempb
--

COMMENT ON COLUMN obj_estate.bicycle_stake_bar_code IS '车桩二维码';
...
--
-- Name: obj_estate_excel_id_seq; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE obj_estate_excel_id_seq OWNED BY obj_estate_excel.id;
...
--
-- Name: obj_fault_type; Type: TABLE; Schema: business; Owner: mempb
--

CREATE TABLE obj_fault_type (
    id integer NOT NULL,
    name character varying(50),
    name_en character varying(50),
    category integer,
...
ALTER TABLE obj_fault_type OWNER TO mempb;

--
-- Name: obj_fault_type_id_seq; Type: SEQUENCE; Schema: business; Owner: mempb
--

CREATE SEQUENCE obj_fault_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE obj_fault_type_id_seq OWNER TO mempb;

--
-- Name: obj_fault_type_id_seq; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE obj_fault_type_id_seq OWNED BY obj_fault_type.id;
...
CREATE TABLE obj_station (
    ...
    station_message character varying(225) DEFAULT nextval('seq_bar_code_message'::regclass),
    check_user_id integer
);
...
--
-- Name: COLUMN obj_station.estate_count; Type: COMMENT; Schema: business; Owner: mempb
--

COMMENT ON COLUMN obj_station.estate_count IS '车位数';
...
--
-- Name: obj_station_excel_id_seq; Type: SEQUENCE; Schema: business; Owner: mempb
--

CREATE SEQUENCE obj_station_excel_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE obj_station_excel_id_seq OWNER TO mempb;
...
--
-- Name: obj_station_excel_id_seq1; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE obj_station_excel_id_seq1 OWNED BY obj_station_excel.id;
...
--
-- Name: obj_stock_record_month_count; Type: TABLE; Schema: business; Owner: mempb
--

CREATE TABLE obj_stock_record_month_count (
    id integer NOT NULL,
    estate_type_id integer,
    count integer,
    create_time timestamp without time zone DEFAULT now(),
...
ALTER TABLE obj_stock_record_month_count OWNER TO mempb;

--
-- Name: obj_stock_record_month_count_id_seq; Type: SEQUENCE; Schema: business; Owner: mempb
--

CREATE SEQUENCE obj_stock_record_month_count_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE obj_stock_record_month_count_id_seq OWNER TO mempb;

--
-- Name: obj_stock_record_month_count_id_seq; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE obj_stock_record_month_count_id_seq OWNED BY obj_stock_record_month_count.id;
...
CREATE TABLE obj_work_order (
    ...
    fault_id integer,
    check_employee integer,
    close_remark character varying(255),
    repair_back_time time with time zone,
    repair_back_remark character varying(255),
...
--
-- Name: obj_work_order_fault_type; Type: TABLE; Schema: business; Owner: mempb
--

CREATE TABLE obj_work_order_fault_type (
    id integer NOT NULL,
    work_order_id integer,
...
ALTER TABLE obj_work_order_fault_type OWNER TO mempb;

--
-- Name: obj_work_order_fault_type_id_seq; Type: SEQUENCE; Schema: business; Owner: mempb
--

CREATE SEQUENCE obj_work_order_fault_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE obj_work_order_fault_type_id_seq OWNER TO mempb;

--
-- Name: obj_work_order_fault_type_id_seq; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE obj_work_order_fault_type_id_seq OWNED BY obj_work_order_fault_type.id;
...
--
-- Name: sys_user_position_record_now; Type: TABLE; Schema: business; Owner: mempb
--

CREATE TABLE sys_user_position_record_now (
    id integer NOT NULL,
    user_id integer,
    longitude double precision,
    latitude double precision,
...
ALTER TABLE sys_user_position_record_now OWNER TO mempb;

--
-- Name: sys_user_position_record_now_id_seq; Type: SEQUENCE; Schema: business; Owner: mempb
--

CREATE SEQUENCE sys_user_position_record_now_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE sys_user_position_record_now_id_seq OWNER TO mempb;

--
-- Name: sys_user_position_record_now_id_seq; Type: SEQUENCE OWNED BY; Schema: business; Owner: mempb
--

ALTER SEQUENCE sys_user_position_record_now_id_seq OWNED BY sys_user_position_record_now.id;
...
--
-- Name: vw_fault_type; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_fault_type AS
 SELECT oft.id,
    oft.name,
    oft.workpoints,
    oft.estate_type_id,
    ...
    oft.create_time,
    oft.create_by,
    oft.last_update_time,
    oft.last_update_by,
    oft.remove_time,
    oet.parts_type
   FROM (obj_fault_type oft
     LEFT JOIN obj_estate_type oet ON (((oet.remove_time IS NULL) AND (oft.estate_type_id = oet.id))));


ALTER TABLE vw_fault_type OWNER TO mempb;
...
CREATE VIEW vw_obj_station AS
 SELECT DISTINCT os.id,
    ...
    os.principal,
    os.check_user_id,
    su.user_name AS check_user_name,
    os.create_time,
    os.create_by,
    os.last_update_time,
    os.last_update_by,
   ...
   FROM ((obj_station os
     ...
     LEFT JOIN sys_user su ON (((su.remove_time IS NULL) AND (su.id = os.check_user_id))));
...
--
-- Name: vw_stock_record_month_count; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_stock_record_month_count AS
 SELECT osr.id,
    osr.estate_type_id,
    osr.count,
    oet.name AS estate_type_name,
    ...
    osr.last_update_by,
    osr.remove_time
   FROM (((obj_stock_record_month_count osr
     JOIN sys_user su ON (((su.remove_time IS NULL) AND (su.id = osr.create_by))))
     JOIN obj_estate_type oet ON (((oet.remove_time IS NULL) AND (oet.id = osr.estate_type_id))))
     JOIN obj_corporation oc ON (((oc.remove_time IS NULL) AND (oc.id = osr.corp_id))));


ALTER TABLE vw_stock_record_month_count OWNER TO mempb;
...
--
-- Name: vw_sys_user_position_record_now; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_sys_user_position_record_now AS
 SELECT suprn.id,
    suprn.user_id,
    suprn.longitude,
    suprn.latitude,
    ...
    suprn.create_time,
    suprn.create_by,
    suprn.last_update_time,
    suprn.last_update_by,
    suprn.remove_time
   FROM ((sys_user_position_record_now suprn
     JOIN sys_user su ON (((su.remove_time IS NULL) AND (su.id = suprn.user_id))))
     JOIN obj_corporation oc ON (((oc.remove_time IS NULL) AND (oc.id = su.corp_id))));


ALTER TABLE vw_sys_user_position_record_now OWNER TO mempb;
...
CREATE VIEW vw_work_order AS
 SELECT owo.id,
    ...
    ss.station_no,
    owo.fault_id,
    oft.name AS fault_name,
    owo.check_employee,
    rreuu.user_name AS check_employee_user_name,
    owo.close_remark,
    owo.repair_back_time,
    owo.repair_back_remark
   FROM ((((((((((((obj_work_order owo
     ...
     LEFT JOIN obj_fault_type oft ON (((oft.remove_time IS NULL) AND (owo.fault_id = oft.id))))
     LEFT JOIN sys_user rreuu ON (((rreuu.remove_time IS NULL) AND (rreuu.id = owo.check_employee))));
...
--
-- Name: vw_work_order_bad_component_fault_type; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_work_order_bad_component_fault_type AS
 SELECT owobc.id,
    owobc.work_order_id,
    owobcc.estate_type_id,
    oet.name AS estate_type_name,
    owobc.fault_type_id,
    oft.name AS fault_type_name,
    owobc.create_time,
    owobc.create_by,
    owobc.last_update_time,
    owobc.last_update_by,
    ...
    owo.score_deduct_remark,
    ss.station_no
   FROM (((((((((((((((obj_work_order_fault_type owobc
     LEFT JOIN obj_work_order owo ON (((owo.remove_time IS NULL) AND (owo.id = owobc.work_order_id))))
     LEFT JOIN obj_fault_type oft ON (((owo.remove_time IS NULL) AND (oft.id = owobc.fault_type_id))))
     LEFT JOIN obj_work_order_bad_component owobcc ON (((owobcc.remove_time IS NULL) AND (owobcc.work_order_id = owo.id))))
     LEFT JOIN obj_estate_type oet ON (((oet.remove_time IS NULL) AND (oet.id = owobcc.estate_type_id))))
     LEFT JOIN sys_user su ON (((su.remove_time IS NULL) AND (su.id = owobc.create_by))))
     LEFT JOIN sys_user suu ON (((suu.remove_time IS NULL) AND (suu.id = owobc.last_update_by))))
     LEFT JOIN obj_station ss ON (((ss.remove_time IS NULL) AND (owo.station_id = ss.id))))
     LEFT JOIN obj_estate oe ON (((oe.remove_time IS NULL) AND (oe.id = owo.estate_id))))
...
ALTER TABLE vw_work_order_bad_component_fault_type OWNER TO mempb;

--
-- Name: vw_work_order_bad_component_fault_type_sum; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_work_order_bad_component_fault_type_sum AS
 SELECT owo.id,
    owo.estate_id,
    owo.type_id,
    owobcc.estate_type_id,
    oet.name AS estate_type_name,
    oft.id AS fault_type_id,
    oft.name AS fault_type_name,
    owo.report_employee,
    owo.report_time,
    owo.assign_time,
   ...
   FROM ((((((((((((((obj_work_order owo
     ...
     LEFT JOIN obj_fault_type oft ON (((oft.remove_time IS NULL) AND (owo.fault_id = oft.id))))
     LEFT JOIN sys_user rreuu ON (((rreuu.remove_time IS NULL) AND (rreuu.id = owo.check_employee))))
     LEFT JOIN obj_work_order_fault_type owoft ON (((owoft.remove_time IS NULL) AND (owoft.work_order_id = owo.id))));


ALTER TABLE vw_work_order_bad_component_fault_type_sum OWNER TO mempb;

--
-- Name: vw_work_order_fault_type; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_work_order_fault_type AS
 SELECT owo.id,
    owo.estate_id,
    owo.type_id,
    owo.report_employee,
...
ALTER TABLE vw_work_order_fault_type OWNER TO mempb;

--
-- Name: vw_work_order_fault_type_count; Type: VIEW; Schema: business; Owner: mempb
--

CREATE VIEW vw_work_order_fault_type_count AS
 SELECT owobc.id,
    owobc.work_order_id,
    owobc.fault_type_id,
    oft.name AS fault_type_name,
   ...
   FROM ((((((((((((((obj_work_order_fault_type owobc
     LEFT JOIN obj_work_order owo ON (((owo.remove_time IS NULL) AND (owo.id = owobc.work_order_id))))
     LEFT JOIN obj_fault_type oft ON (((owo.remove_time IS NULL) AND (oft.id = owobc.fault_type_id))))
     LEFT JOIN obj_estate_type oet ON (((oet.remove_time IS NULL) AND (oet.id = oft.estate_type_id))))
     LEFT JOIN sys_user su ON (((su.remove_time IS NULL) AND (su.id = owobc.create_by))))
     LEFT JOIN sys_user suu ON (((suu.remove_time IS NULL) AND (suu.id = owobc.last_update_by))))
     LEFT JOIN obj_station ss ON (((ss.remove_time IS NULL) AND (owo.station_id = ss.id))))
     LEFT JOIN obj_estate oe ON (((oe.remove_time IS NULL) AND (oe.id = owo.estate_id))))
...
ALTER TABLE vw_work_order_fault_type_count OWNER TO mempb;
...
--
-- Name: id; Type: DEFAULT; Schema: business; Owner: mempb
--
...
ALTER TABLE ONLY obj_estate_excel ALTER COLUMN id SET DEFAULT nextval('obj_estate_excel_id_seq'::regclass);
...
ALTER TABLE ONLY obj_fault_type ALTER COLUMN id SET DEFAULT nextval('obj_fault_type_id_seq'::regclass);
...
ALTER TABLE ONLY obj_station_excel ALTER COLUMN id SET DEFAULT nextval('obj_station_excel_id_seq1'::regclass);
...
ALTER TABLE ONLY obj_stock_record_month_count ALTER COLUMN id SET DEFAULT nextval('obj_stock_record_month_count_id_seq'::regclass);
...
ALTER TABLE ONLY obj_work_order_fault_type ALTER COLUMN id SET DEFAULT nextval('obj_work_order_fault_type_id_seq'::regclass);
...
ALTER TABLE ONLY sys_user_position_record_now ALTER COLUMN id SET DEFAULT nextval('sys_user_position_record_now_id_seq'::regclass);
...
--
-- Name: asso_estate_module_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: asso_user_project_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_barcode_image_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_corporation_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_device_push_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_estate_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_estate_status_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_estate_supplier_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_estate_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_fault_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--

ALTER TABLE ONLY obj_fault_type
    ADD CONSTRAINT obj_fault_type_pkey PRIMARY KEY (id);


--
-- Name: obj_file_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_inventory_check_record_detail_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_inventory_check_record_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_inventory_record_detail_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_inventory_record_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_station_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_record_month_count_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--

ALTER TABLE ONLY obj_stock_record_month_count
    ADD CONSTRAINT obj_stock_record_month_count_pkey PRIMARY KEY (id);


--
-- Name: obj_stock_record_personal_history_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_record_personal_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_record_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_work_order_detail_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_work_order_history_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_work_order_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_stock_work_order_resource_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_work_order_bad_component_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_work_order_fault_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--

ALTER TABLE ONLY obj_work_order_fault_type
    ADD CONSTRAINT obj_work_order_fault_type_pkey PRIMARY KEY (id);


--
-- Name: obj_work_order_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_work_order_resource_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: obj_workorder_operation_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: ref_stock_work_order_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: ref_tock_work_order_status_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: ref_work_order_status_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: ref_work_order_type_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_message_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_message_send_detail_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_param_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_project_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_resource_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_role_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_role_resource_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_user_detail_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_user_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_user_point_record_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_user_position_record_now_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--

ALTER TABLE ONLY sys_user_position_record_now
    ADD CONSTRAINT sys_user_position_record_now_pkey PRIMARY KEY (id);


--
-- Name: sys_user_position_record_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_user_role_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
...
--
-- Name: sys_version_app_pkey; Type: CONSTRAINT; Schema: business; Owner: mempb
--
