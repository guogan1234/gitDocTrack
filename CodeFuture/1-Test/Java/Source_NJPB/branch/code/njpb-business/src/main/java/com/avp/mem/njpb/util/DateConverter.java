...
public class DateConverter implements Converter {
    ...
    private static final String MONTH_PATTERN_POINT = "yyyy.MM";

    /**
     * 检验时间是否在时间段内
     */
    public static String getMonthStr(Date date) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(MONTH_PATTERN_POINT);
     ...
     * @return
     */
    public static String doConvertToDateString(Object value) {
