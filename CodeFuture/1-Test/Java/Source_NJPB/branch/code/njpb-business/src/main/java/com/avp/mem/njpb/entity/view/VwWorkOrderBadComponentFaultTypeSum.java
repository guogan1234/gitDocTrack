...
@Table(name = "vw_work_order_bad_component_fault_type_sum", schema = "business")
public class VwWorkOrderBadComponentFaultTypeSum extends EntityBase {
    ...
    @Transient
    private String replaceEstates;


    public String getReplaceEstates() {
        return replaceEstates;
    }

    public void setReplaceEstates(String replaceEstates) {
        this.replaceEstates = replaceEstates;
    }
