...
@Table(name = "vw_work_order_fault_type_count", schema = "business")
public class VwWorkOrderFaultTypeCount extends EntityBase {
    ...
    public Integer getFaultTypeName() {
        return faultTypeName;
    }

    public void setFaultTypeName(Integer faultTypeName) {
