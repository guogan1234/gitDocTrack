...
$(function () {
    ...
    initLeftActive('report_station_repair_list');
    initSelect();
    initDataTable();
    addBtn();
...
function openDialogDetail(projectId, stationId, estateTypeId, faultTypeId, statusId, repairEmployee, rowid, domId) {
    ...
    rowJson = json;
    console.log(rowJson)
    urlTemp = "/business-resource/workOrders/list?1=1";
...
function exportDetail() {
    ...
    var url = '/business-resource/stationRepairDetailExport?1=1&typeId = 1;';
