...
$(function () {
    ...
    initLeftActive('report_station_maintain');
    initSelect();
...
function initSelect() {
    ...
    $.ajax({
        type: 'GET',
        url: '/business-resource/estateTypes?partsType=' + 1 + "&category=1",
        dataType: 'JSON',
        contentType: 'application/json',
        success: function (retData) {
            ...
            $("#estateTypeId").val("-1").trigger("change");
    ...
    $.ajax({
        type: 'GET',
        url: '/business-resource/faultType?partsType=' + 1,
        dataType: 'JSON',
        contentType: 'application/json',
        success: function (retData) {
            var data = [];
...
function exportExcel() {
    ...
    //     return;
    // }
    var url = '/business-resource/stationFaultStatisticsExport?reportWay=1&typeId=2';
