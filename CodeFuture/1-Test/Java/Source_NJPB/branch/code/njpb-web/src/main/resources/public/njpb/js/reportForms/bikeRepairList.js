...
$(function () {
    ...
    initLeftActive('report_bike_repair_list');
    initSelect();
    initDataTable();
    addBtn();
...
function openDialogDetail(bikeFrameNo,projectId, stationId, estateTypeId, faultTypeId, statusId, repairEmployee, rowid, domId) {
    ...
    rowJson = json;
    console.log(rowJson)
    urlTemp = "/business-resource/workOrders/bikeList?1=1&typeId=1;";
...
function exportDetail() {
    ...
    var url = '/business-resource/bikeDetailExport?1=1&typeId=1;';
